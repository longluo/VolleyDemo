...
public class MainActivity extends Activity {
    ...
    private Button mNetworkDemo;

    private Button mUpdateDemo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNetworkDemo = (Button) findViewById(R.id.network);
        mNetworkDemo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, NetworkDemoActivity.class));
            }
        });

        mUpdateDemo = (Button) findViewById(R.id.update);
        mUpdateDemo.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, UpdateDemoActivity.class));
            }
        });
