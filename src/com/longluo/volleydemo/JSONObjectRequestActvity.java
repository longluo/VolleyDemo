...
public class JSONObjectRequestActvity extends Activity {
    ...
    private void makeSampleHttpRequest() {
        ...
        Log.d(TAG, "JSON url=" + builder.toString());
    ...
    private class EfficientAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            mImageLoader.get(mDataList.get(position).getImageUrl(), new FadeInImageListener(
                    holder.image, JSONObjectRequestActvity.this));

            /*
             * mImageLoader.get(mDataList.get(position).getImageUrl(),
             * ImageLoader.getImageListener(holder.image, R.drawable.flickr,
             * android.R.drawable.ic_dialog_alert), //You can specify width &
             * height of the bitmap to be scaled down when the image is
             * downloaded. 50,50);
             */
            return convertView;
        }
