...
/**
 * Demonstrates how to execute ImageRequest and NetworkImageView to download a
 * image from a URL using Volley library.
 * 
...
public class NetworkImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Memorycache is always faster than DiskCache. Check it our for
        // yourself.
        ...
        /*
         * Demonstrating 3 ways of image downloading. 1 - Using ImageLoader and
         * passing a url and imageListener. Additionally u can pass w & h 2 -
         * User NetworkImageView and pass a url & ImageLoader
         * 
         * The above 2 uses underlying 'ImageRequest' to initiate the download.
         * 3 - Directly use ImageRequest api, by passing url, w & h, listeners,
         * and BitmapConfig It has default retry mechanism i set to 2 maximum
         * retries.
         */

        // 1) In case you are showing image as user icon normally 50x50, you can
        // specify the width & height.
        mImageLoader.get(testUrlToDownloadImage1, ImageLoader.getImageListener(mImageView1,
                R.drawable.flickr, android.R.drawable.ic_dialog_alert),
        // You can specify width & height of the bitmap to be scaled down when
        // the image is downloaded.
                50, 50);

        // 1 & 2) are almost same. Demonstrating you can apply animations while
        // showing the downloaded image.
        // You can use nice entry animations while showing images in a
        // listview.Uses custom implemented 'FadeInImageListener'.
    ...
    private void makeSampleHttpRequest() {
        ...
        Log.d(TAG, "makeSampleHttpRequest, url=" + builder.toString());

        jsonObjRequest = new JsonObjectRequest(Request.Method.GET, builder.toString(), null,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        System.out.println("####### Response JsonObjectRequest SUCCESS  ######## "
                                + response.toString());
                        try {
